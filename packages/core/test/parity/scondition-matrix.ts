...
export const REFERENCE_DATASET: ReadonlyArray<RefUser> = [
  { id: 1, email: '1@example.com', nameFirst: 'Alice', nameLast: 'Smith', isActive: true, companyId: 1, profileId: 1, age: 25 },
  { id: 2, email: '2@example.com', nameFirst: 'Bob', nameLast: 'Jones', isActive: true, companyId: 1, profileId: 2, age: 30 },
  { id: 3, email: '3@example.com', nameFirst: 'Carol', nameLast: 'White', isActive: true, companyId: 2, profileId: null, age: 22 },
  { id: 4, email: '4@example.com', nameFirst: 'Dave', nameLast: 'Brown', isActive: false, companyId: 2, profileId: null, age: 28 },
  { id: 5, email: '5@example.com', nameFirst: 'Eve', nameLast: 'Davis', isActive: true, companyId: 3, profileId: 5, age: 35 },
  { id: 6, email: '6@foo.com', nameFirst: 'Frank', nameLast: 'Miller', isActive: true, companyId: 3, profileId: 6, age: 40 },
  { id: 7, email: '7@foo.com', nameFirst: 'Grace', nameLast: 'Wilson', isActive: false, companyId: 4, profileId: null, age: 18 },
  { id: 8, email: '8@example.com', nameFirst: 'Hank', nameLast: 'Moore', isActive: false, companyId: 4, profileId: 8, age: 45 },
  { id: 9, email: '9@example.com', nameFirst: 'Ivy', nameLast: 'Taylor', isActive: false, companyId: 5, profileId: 9, age: 32 },
  { id: 10, email: '10@example.com', nameFirst: 'Jack', nameLast: 'Anderson', isActive: true, companyId: 5, profileId: 10, age: 27 },
];
